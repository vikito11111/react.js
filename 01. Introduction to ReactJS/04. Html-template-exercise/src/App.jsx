...
function App() {
    const getCurrentYear = () => {
        ...
        console.log("Year element found:", yearElement);
    ...
    // Ensure the function is called after the component mounts
    useEffect(() => {
        getCurrentYear();
    }, []);
            ...
            <section className="feature_section">
                <div className="container">
                    <div className="feature_container">
                        <div className="box">
                            <div className="img-box">
                                <svg enableBackground="new 0 0 511.995 511.995" height="512" viewBox="0 0 511.995 511.995"
