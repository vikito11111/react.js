                    ...
                    <div className="row">
                        <div className="col-md-8 col-sm-12">
                            <div className="banner-text">
                                ...
                                <h6 className="white">This awesome template designed by <a href="http://w3Template.com"
                                    target="_blank" rel="dofollow" className="weblink">W3 Template</a>.</h6>
                                <p className="banner-text white">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        ...
                        <div className="col-md-4 col-sm-12"> <img src="images/iphone-screen.png"
